...
mod tests {
    ...
    prop_compose! {
        fn random_msg_bytes_strategy(max_size: i32)
    ...
    prop_compose! {
        fn random_msg_bytes_eof_strategy(max_size: i32)
    ...
    prop_compose! {
        fn refbox2013_team_info_strategy()(name in "\\PC*",
    ...
    prop_compose! {
        fn refbox2013_strategy()(packet_timestamp in proptest::num::u64::ANY,
    ...
    prop_compose! {
        fn detection_frame_strategy()(frame_number in proptest::num::u32::ANY,
    ...
    prop_compose! {
        fn geometry_field_size_strategy()(field_length in proptest::num::i32::ANY,
    ...
    prop_compose! {
        fn geometry_data_strategy()(field in geometry_field_size_strategy()
    ...
    prop_compose! {
        fn vision2014_strategy()(detection in detection_frame_strategy(),
